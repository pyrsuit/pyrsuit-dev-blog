const t=`<div class="flex items-baseline justify-between mb-2">
...
You describe what you want to cook this week in plain English. The agent checks what you already have at home and returns a structured, categorized shopping list with only the things you actually need to buy. No cloud API, no sign-up - it runs on your machine.

\`\`\`mermaid
graph LR
    A[meal description] --> B[PydanticAI Agent]
    B --> C[get_inventory]
    C --> D[inventory.json]
    D --> C
    C --> B
